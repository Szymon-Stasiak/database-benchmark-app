...
class PgDataSourceCacheIntegrationTest {
    ...
    void connectsToRealPostgresAndExecutesQuery() throws Exception {
        ...
        try (Connection conn = ds.getConnection();
            ...
            stmt.execute(
                    "CREATE TABLE products (id INT PRIMARY KEY, name TEXT NOT NULL, price NUMERIC(10,2))");
            stmt.executeUpdate(
                    "INSERT INTO products (id, name, price) VALUES (1, 'Widget', 9.99), (2, 'Gadget', 19.50)");

            try (ResultSet rs =
                    stmt.executeQuery("SELECT id, name, price FROM products ORDER BY id")) {
