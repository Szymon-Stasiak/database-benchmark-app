...
public final class BulkInsertLoop {
    ...
    public record Config(
            ...
            String failureLogFormat,
            String conflictLogFormat,
            String logSubject) {}

    public static EntityOutcome run(
            InsertContext ctx,
            CascadeNode node,
