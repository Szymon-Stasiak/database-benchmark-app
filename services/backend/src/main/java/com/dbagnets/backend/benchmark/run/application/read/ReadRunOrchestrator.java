...
public class ReadRunOrchestrator extends AbstractEntityRunOrchestrator {
    ...
    protected String runStatusEventName() {
        return SseEvents.EVENT_READ_RUN_STATUS;
    }

    @Override
    protected String resultStatusEventName() {
        return SseEvents.EVENT_READ_RESULT_STATUS;
    }

    @Override
    protected Object toResultResponse(BenchmarkResult result) {
        return ReadResultResponse.from(result);
    }
    ...
    public PreparedRunResponse prepareRun(String benchmarkId, StartReadRunRequest request) {
        ...
        sse.sendEvent(
                benchmarkId,
                SseEvents.EVENT_READ_RUN_PREPARED,
    ...
    private ReadDepth parseReadDepth(String configJson) {
        ...
        try {
            return objectMapper
                    .readValue(configJson, StartReadRunRequest.class)
                    .readDepthOrDefault();
        } catch (Exception e) {
            return ReadDepth.NONE;
        }
    }
