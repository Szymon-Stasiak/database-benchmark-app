...
public final class ForeignKeyResolver {
    ...
    private static Optional<LogicalAttribute> findFkAttribute(
            List<LogicalAttribute> attrs, String parentName) {
    ...
    private static String unresolvedMessage(
            LogicalRelationship rel, LogicalEntity child, LogicalEntity parent) {
