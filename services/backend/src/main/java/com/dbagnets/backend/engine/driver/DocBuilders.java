...
public final class DocBuilders {
    ...
    public static Map<String, Object> withPk(String pkField, LogicalEntity entity, GeneratedRow row) {
        return withPk(pkField, entity, row, Function.identity());
    }

    public static Map<String, Object> withPkAsString(String pkField, LogicalEntity entity, GeneratedRow row) {
        return withPk(pkField, entity, row, v -> v == null ? null : String.valueOf(v));
    }

    public static Map<String, Object> withPk(String pkField, LogicalEntity entity, GeneratedRow row, Function<Object, Object> pkCoercer) {
