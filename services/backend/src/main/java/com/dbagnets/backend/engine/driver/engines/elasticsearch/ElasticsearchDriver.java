package com.dbagnets.backend.engine.driver.engines.elasticsearch;
                ...
                entry -> {
                    JsonNode resp =
                            client.delete()
                                    ...
                                    .block();
                    return resp != null
                                    && "deleted".equalsIgnoreCase(resp.path("result").asText(""))
                            ? 1
                            : 0;
                });
    }
                        ...
                        Map<String, Object> action =
                                Map.of(
                                        ...
                                        Map.of(
                                                ...
                                                index,
                                                "_id",
                                                String.valueOf(row.logicalId())));
                        ndjson.append(objectMapper.writeValueAsString(action)).append('\n');
                        ndjson.append(objectMapper.writeValueAsString(DriverValues.rowToMap(row)))
                                .append('\n');
                    }
                    client.post()
                            .uri("/_bulk")
