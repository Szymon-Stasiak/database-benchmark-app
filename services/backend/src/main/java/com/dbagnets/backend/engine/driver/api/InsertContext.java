...
public record InsertContext(String benchmarkId, String databaseId, String dbName, String dbVersion, String hostAddress,
                            int hostPort, LogicalSchema schema, EmbeddingMap embeddings, CascadePlan plan,
                            Map<String, List<GeneratedRow>> rowsByEntity, InsertMode mode, int batchSize,
